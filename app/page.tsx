    ...
    <main>
      ...
      <header className="hero" id="top">
        ...
        <div className="hero-grid">
          ...
          <div className="hero-actions"><a className="primary-button" href="#projects">Explore product work <span>↓</span></a><a className="secondary-button" href="#experience">See career impact <span>↓</span></a><a className="secondary-button" href={sitePath("/how-i-work/")}>How I work <span>→</span></a><a className="text-link" href="mailto:gokulg846@gmail.com">Email me</a></div>
        </div>
